          ...
          <div className="project1-tab-horizontal">
            ...
            <div className="project1-content">
              ...
              <span className="thq-body-small">
                <p>Our research project in Dr. Nance's Lab at the University of Washington focuses on 
              ...
              <p><b>Presentations:</b> SciPy 2024 Poster Presentation, Mary Gates Sympisum</p>
            </div>
          </div>
        </div>
      </div>
